...
// ==========================================
// Start perpendicular at top (12 o'clock = -90deg) and revolve 360deg in same direction to 270deg with slow speed (80s)
sharedLib = sharedLib.replace(
  /vl=\{[^\}]+\},yl=\{opacity:1,rotate:[^,]+,rotateX:0,rotateY:0,scale:1,skewX:0,skewY:0,x:0,y:0\}/g,
  "vl={delay:0,duration:80,ease:[0,0,1,1],type:`tween`},yl={opacity:1,rotate:270,rotateX:0,rotateY:0,scale:1,skewX:0,skewY:0,x:0,y:0}"
);

fs.writeFileSync(sharedLibPath, sharedLib, "utf8");
console.log("Updated shared-lib.CfkmGO52.mjs!");
...
<style id="custom-enhancements">
  /* 1. Black Part Moved Down: Showing More of the Watch & Arch */
  .framer-y1onvt {
    background: linear-gradient(180deg, 
      rgba(10, 13, 20, 0) 0%, 
      rgba(10, 13, 20, 0) 22%, 
      rgba(10, 13, 20, 0.45) 34%, 
  ...
  @media (min-width: 720px) and (max-width: 1199.98px) {
    .framer-y1onvt {
      background: linear-gradient(180deg, 
        rgba(10, 13, 20, 0) 0%, 
        rgba(10, 13, 20, 0) 20%, 
        rgba(10, 13, 20, 0.45) 32%, 
        rgba(10, 13, 20, 0.88) 48%, 
        #0a0d14 62%, 
        #0a0d14 100%
      ) !important;
    }
  ...
  @media (max-width: 719.98px) {
    .framer-y1onvt {
      background: linear-gradient(180deg, 
        rgba(10, 13, 20, 0) 0%, 
        rgba(10, 13, 20, 0) 18%, 
        rgba(10, 13, 20, 0.45) 30%, 
        rgba(10, 13, 20, 0.88) 45%, 
        #0a0d14 58%, 
        #0a0d14 100%
      ) !important;
    }
  ...
  /* Natural non-boxy text container with deep shadow readability */
  .framer-1nxi3rr {
  ...
  /* 2. Earth: Extended Length to Last Outer Ring, Larger Size, Starting Perpendicular */
  .framer-1w9q7pm {
    width: 97% !important;
    left: 1.5% !important;
  ...
  .framer-1ig6k18 {
    ...
    box-shadow: 0 0 22px rgba(70, 175, 255, 1), 0 0 45px rgba(0, 130, 255, 0.75), 0 0 65px rgba(0, 80, 220, 0.5) !important;
...
(function() {
  ...
  // 2. Comprehensive English <-> Hindi Translation Map
  var translations = [
    // Navbar
...
console.log("Updated public/index.html with v2 modifications!");
