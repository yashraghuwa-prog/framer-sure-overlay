...
// Remove the badge HTML element if present
html = html.replace(/<div id="__framer-badge-container"[\s\S]*?<\/div>\s*<\/div>/g, "");
...
<style id="custom-enhancements">
  ...
  /* 2. Black Part & Text Moved Down Together: Showing more of the watch */
  .framer-y1onvt {
  ...
  /* Text readability with deep shadow */
  .framer-1nxi3rr {
  ...
  /* 3. Earth: Reaches last outer ring, starts perpendicular (12 o clock), revolves smoothly in same direction */
  @keyframes orbitEarthPerpendicular {
    0% {
  ...
  .framer-1w9q7pm {
    ...
    animation: orbitEarthPerpendicular 75s linear infinite !important;
  ...
  .framer-1ig6k18 {
    ...
    box-shadow: 0 0 22px rgba(70, 175, 255, 1), 0 0 45px rgba(0, 130, 255, 0.8), 0 0 70px rgba(0, 80, 220, 0.5) !important;
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
...
console.log("Applied v3 modifications successfully!");
